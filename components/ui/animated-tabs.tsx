...
return (
  <div className={cn("w-full max-w-6xl mx-auto flex flex-col gap-y-1", className)}>
    <div className="flex mx-auto gap-2 flex-wrap bg-[#11111198] bg-opacity-50 backdrop-blur-sm p-1 rounded-xl">
      {tabs.map((tab) => (
        <button
          key={tab.id}
